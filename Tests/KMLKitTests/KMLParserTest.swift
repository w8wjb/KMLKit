...
class KMLParserTest: XCTestCase {
    ...
    func testParseLibKMLExamples() throws {
        ...
        let subdirs = try XCTUnwrap(Bundle.module.urls(forResourcesWithExtension: nil, subdirectory: "Resources/testdata"))
        ...
        for subdir in subdirs {
            ...
            let kmls = Bundle.module.urls(forResourcesWithExtension: "kml", subdirectory: "Resources/testdata/\(subdir.lastPathComponent)") ?? []
