...
open class KMLTimeStamp: KMLObject, KMLTimePrimitive {
    ...
    internal static var gYearFormatter: DateFormatter {
        get {
    ...
    internal static var gYearMonthFormatter: DateFormatter {
        get {
            let formatter = DateFormatter()
    ...
    internal static var dateTimeFormatter: ISO8601DateFormatter {
        get {
